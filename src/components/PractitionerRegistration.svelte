...
>
  ...
  <br>
  <div class="field">
    <mb-date datatype="date" label="Date of birth" path="birthDate" />
  </div>
  <br>
  <div class="field">
  ...
  <br>
  <div class="field">
    <mb-input type="ContactPoint" path="contact[0].telecom[0].value[0]" placeholder="Attendant Phone Number" />
  </div>
  <div class="field">
  ...
  <br>
  <div class="field">
    <mb-input type="ContactPoint" path="contact[0].telecom[1].value[0]" placeholder="Attendant Email Address" />
  </div>
  <br>
  <mb-submit>
